...
import { getTripDetails, getNotifications, readNotification } from "@/lib/action";
...
const PAGE_SIZE = 10;
const Dashboard: FC<clientDetailsProps> = ({ showClientDetails }) => {
  ...
  useEffect(() => {
    ...
    getNotifications(userData._id).then(data=>{
  ...
  const handleFilterOption = (option: any) => {
  ...
  // screen width for these buttons is working
            ...
            <div className={classes.filters}>
              ...
              <Link
                ...
                <Link
                  ...
                  className="hidden lg:w-full hover:bg-[#C5BCF4] flex rounded-full items-center justify-start lg:block"
                >
                  <li className="flex px-2 py-1 items-center justify-start">
                    <Wallet className="w-7 mr-3 ml-2 block md:hidden lg:block" />
                    Bookings
                  </li>
                </Link>
